 ...
 */
public class medicalSub extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_medical_sub, container, false);
        initView(view);
    ...
    private void initView(View view) {
        ...
        lytSub13 = (LinearLayout) view.findViewById(R.id.lytSub13);
    }
